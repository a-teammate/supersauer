...
extern bool settexture(const char *name, int clamp = 0, bool mipmaps = true);
...
/*Rec*/
extern void resetorigin();
extern void playonce();
extern int playmillis;
extern stream * playing;
/*Rec*/
...
extern void clearparticles(); //ext demo
...
struct serverinfo
{
	...
	void * extinfo;
	serverinfo()
		: port(-1), numplayers(0), resolved(0), keep(false), password(NULL), extinfo(NULL)
	{
...
struct g3d_gui
{
    ...
    int textf(const char *fmt, int color, const char *icon = NULL, const char *desc = NULL, ...) PRINTFARGS(2, 5)
    {
	...
	int buttonf(const char *fmt, int color, const char *icon = NULL, const char *desc = NULL, ...) PRINTFARGS(2, 5)
    {
        defvformatstring(str, desc, fmt);
        return button(str, color, icon, desc);
    }
    virtual int title(const char *text, int color, const char *icon = NULL, const char *desc = NULL) = 0;
    int titlef(const char *fmt, int color, const char *icon = NULL, const char *desc = NULL, ...) PRINTFARGS(2, 5)
    {
        defvformatstring(str, desc, fmt);
...
extern Texture* texload(const char* name, int clamp);
extern int sortbythat;
extern void screenshot(char *filename, bool justfilename = true, int dir = 0);
// 
